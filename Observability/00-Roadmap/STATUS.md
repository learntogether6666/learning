...
- **Done:** `AI-Infra/` rebuilt as a **9-level graduate course** (Foundations L1–6 + Production L7–9), ~4,300 lines, 50 Mermaid diagrams. **Style = teach-first "build a city": analogy → diagram → hyperscale depth → failure modes → interview Q&A.** (Replaced the rejected v1 monolithic Section-1/Section-2 docs.) Level-1 is the approved style exemplar.
